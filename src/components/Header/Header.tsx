...
export const Header = ({ title = 'Mortgage Matrix', onMenuClick }: HeaderProps) => {
  return (
    <header className={styles.header}>
      <div className={styles.logoContainer}>
        ...
        >
          ...
          <path d="M7 8H17" stroke="#059669" strokeWidth="2" strokeLinecap="round" />
          <path d="M7 16H13" stroke="#059669" strokeWidth="2" strokeLinecap="round" />
        </svg>
